...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		g2.scale(1.5625, 1.5625); //poczatkowa skala
		//czerwone prostokaty
		g2.translate(-1.65, -1.3);
		g2.rotate(2.85);
		g2.scale(2.25, 0.15);
		g2.setColor(Color.GRAY);
		filledRect(g2);
		
		g2.scale(0.44, 6.67);  //poczatkowa skala
		g2.rotate(3.43);
	...
	private static void filledPolygon(Graphics2D g2) { // width = 1, height = 1, center of base is at (0,0);
		int n =13;
