...
public class SceneGraph extends JPanel {
    ...
    private TransformedObject tri3;
	...
	private void createWorld() {
		...
		// TODO: Create objects and add them to the scene graph.
	        ...
	        tri3 = new TransformedObject(filledTriangle);
	        ...
	        rotatingPolygon3.setTranslation(1.33,2.23).setScale(0.01,0.01).setColor(Color.black);
	        rotatingPolygon4.setTranslation(2.7,1.75).setScale(0.01,0.01).setColor(Color.black);
	        rotatingPolygon5.setTranslation(-1.6,1).setScale(0.013,0.013).setColor(Color.black);
	        rotatingPolygon6.setTranslation(-3.24,1.6).setScale(0.013,0.013).setColor(Color.black);

	        tri1.setTranslation(0.38,-2.75).setScale(0.7,2.3).setColor(Color.BLUE);
	        tri2.setTranslation(-2.5,-0.4).setScale(0.5,1.7).setColor(Color.MAGENTA);
	        tri3.setTranslation(1.98,0.64).setScale(0.5,1.3).setColor(Color.GREEN);
	        
	        rect1.setTranslation(0.4, -0.4).setScale(2.5, 0.15).setRotation(-20).setColor(Color.gray);
	        rect2.setTranslation(-2.45, 1.3).setScale(1.8, 0.1).setRotation(-20).setColor(Color.gray);
	        rect3.setTranslation(2, 2.0).setScale( 1.5, 0.1).setRotation(-20).setColor(Color.gray);
	...
	public void updateFrame() {
		...
		// TODO: Update state in preparation for drawing the next frame.
	        ...
	        rotatingPolygon2.setRotation(frameNumber*3.5);
	        rotatingPolygon3.setRotation(frameNumber*2);
	        rotatingPolygon4.setRotation(frameNumber*1);
	        rotatingPolygon5.setRotation(frameNumber*5);
